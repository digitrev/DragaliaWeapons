...
#Possibly outdated; need to compare with new cargotables
#parameterDict["MCNodes"]={"tables":"MCNodes","fields":"MC,Id,ManaPieceType,NecessaryManaPoint,UniqueGrowMaterialCount1,UniqueGrowMaterialCount2","order_by":"MC,Id"}
#parameterDict["ManaPieceMaterial"]={"tables":"ManaPieceMaterial","fields":"ElementId,Step,ManaPieceType,MaterialId1,MaterialId2,MaterialId3,MaterialQuantity1,MaterialQuantity2,MaterialQuantity3,DewPoint"}
#replacement tables for mana circle calculations
parameterDict["MCNodeCost"]={"tables":"MCNodeCost","fields":"MC,MCElementId,Floor,No,Material,MaterialQuantity","order_by":"MC,Floor,No"}
